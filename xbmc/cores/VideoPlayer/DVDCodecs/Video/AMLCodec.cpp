...
void CAMLCodec::SetVideoRect(const CRect &SrcRect, const CRect &DestRect)
{
  ...
  const RenderStereoMode guiStereoMode = CServiceBroker::GetWinSystem()->GetGfxContext().GetStereoMode();

...
constexpr uint32_t PLAYER_PROCESS_VIDEO_HDR_TYPE = PLAYER_PROCESS_START + 34;
constexpr uint32_t PLAYER_PROCESS_VIDEO_HDR_TYPE_RAW = PLAYER_PROCESS_START + 35;
constexpr uint32_t PLAYER_PROCESS_VIDEO_SOURCE_HDR_TYPE = PLAYER_PROCESS_START + 36;
constexpr uint32_t PLAYER_PROCESS_VIDEO_SOURCE_HDR_TYPE_RAW = PLAYER_PROCESS_START + 37;
constexpr uint32_t PLAYER_PROCESS_VIDEO_SOURCE_ADDITIONAL_HDR_TYPE = PLAYER_PROCESS_START + 38;
constexpr uint32_t PLAYER_PROCESS_VIDEO_SOURCE_ADDITIONAL_HDR_TYPE_RAW = PLAYER_PROCESS_START + 39;

constexpr uint32_t PLAYER_PROCESS_VIDEO_HDR_HAS_CLL = PLAYER_PROCESS_START + 40;
constexpr uint32_t PLAYER_PROCESS_VIDEO_HDR_MAX_CLL = PLAYER_PROCESS_START + 41;
constexpr uint32_t PLAYER_PROCESS_VIDEO_HDR_MAX_FALL = PLAYER_PROCESS_START + 42;
constexpr uint32_t PLAYER_PROCESS_VIDEO_HDR_HAS_MDCV = PLAYER_PROCESS_START + 43;
constexpr uint32_t PLAYER_PROCESS_VIDEO_HDR_MIN_LUM = PLAYER_PROCESS_START + 44;
constexpr uint32_t PLAYER_PROCESS_VIDEO_HDR_MAX_LUM = PLAYER_PROCESS_START + 45;
constexpr uint32_t PLAYER_PROCESS_VIDEO_HDR_COLOUR_PRIMARIES = PLAYER_PROCESS_START + 46;

constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_HAS_CONFIG = PLAYER_PROCESS_START + 47;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_HAS_HEADER = PLAYER_PROCESS_START + 48;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_VERSION_MAJOR = PLAYER_PROCESS_START + 49;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_VERSION_MINOR = PLAYER_PROCESS_START + 50;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_PROFILE = PLAYER_PROCESS_START + 51;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_LEVEL = PLAYER_PROCESS_START + 52;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_RPU_PRESENT = PLAYER_PROCESS_START + 53;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_EL_PRESENT = PLAYER_PROCESS_START + 54;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_BL_PRESENT = PLAYER_PROCESS_START + 55;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_BL_SIGNAL_COMPATIBILITY = PLAYER_PROCESS_START + 56;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_EL_TYPE = PLAYER_PROCESS_START + 57;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_DUAL_TRACK = PLAYER_PROCESS_START + 58;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_CODEC_FOURCC = PLAYER_PROCESS_START + 59;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_CODEC_STRING = PLAYER_PROCESS_START + 60;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_META_VERSION = PLAYER_PROCESS_START + 61;

constexpr uint32_t PLAYER_PROCESS_VIDEO_SOURCE_DOVI_PROFILE = PLAYER_PROCESS_START + 62;
constexpr uint32_t PLAYER_PROCESS_VIDEO_SOURCE_DOVI_EL_PRESENT = PLAYER_PROCESS_START + 63;
constexpr uint32_t PLAYER_PROCESS_VIDEO_SOURCE_DOVI_EL_TYPE = PLAYER_PROCESS_START + 64;
constexpr uint32_t PLAYER_PROCESS_VIDEO_SOURCE_DOVI_BL_SIGNAL_COMPATIBILITY =
    PLAYER_PROCESS_START + 65;

constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MIN_PQ = PLAYER_PROCESS_START + 66;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MAX_PQ = PLAYER_PROCESS_START + 67;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MIN_NITS = PLAYER_PROCESS_START + 68;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_SOURCE_MAX_NITS = PLAYER_PROCESS_START + 69;

constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_HAS_L6 = PLAYER_PROCESS_START + 70;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_CLL = PLAYER_PROCESS_START + 71;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_FALL = PLAYER_PROCESS_START + 72;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_L6_MIN_LUM = PLAYER_PROCESS_START + 73;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_L6_MAX_LUM = PLAYER_PROCESS_START + 74;

constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_L1_MIN_PQ = PLAYER_PROCESS_START + 75;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_L1_MAX_PQ = PLAYER_PROCESS_START + 76;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_L1_AVG_PQ = PLAYER_PROCESS_START + 77;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_L1_MIN_NITS = PLAYER_PROCESS_START + 78;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_L1_MAX_NITS = PLAYER_PROCESS_START + 79;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_L1_AVG_NITS = PLAYER_PROCESS_START + 80;

constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_HAS_L5 = PLAYER_PROCESS_START + 81;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_L5_LEFT_OFFSET = PLAYER_PROCESS_START + 82;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_L5_RIGHT_OFFSET = PLAYER_PROCESS_START + 83;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_L5_TOP_OFFSET = PLAYER_PROCESS_START + 84;
constexpr uint32_t PLAYER_PROCESS_VIDEO_DOVI_L5_BOTTOM_OFFSET = PLAYER_PROCESS_START + 85;

constexpr uint32_t PLAYER_PROCESS_RENDER_PTS = PLAYER_PROCESS_START + 86;

constexpr uint32_t PLAYER_PROCESS_VIDEO_BIT_DEPTH = PLAYER_PROCESS_START + 87;
constexpr uint32_t PLAYER_PROCESS_VIDEO_COLOR_SPACE = PLAYER_PROCESS_START + 88;
constexpr uint32_t PLAYER_PROCESS_VIDEO_COLOR_RANGE = PLAYER_PROCESS_START + 89;
constexpr uint32_t PLAYER_PROCESS_VIDEO_COLOR_PRIMARIES = PLAYER_PROCESS_START + 90;
constexpr uint32_t PLAYER_PROCESS_VIDEO_COLOR_TRANSFER_CHARACTERISTIC = PLAYER_PROCESS_START + 91;
